...
サーバとWindowsのローカルの間でファイル転送したい場合は<a href="https://winscp.net/eng/docs/lang:jp" target="_blank">WinSCP</a>や<a href="https://www.samba.org/" target="_blank">Samba</a>などがあります。
