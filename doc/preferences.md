...
サーバ上に環境構築したいがIDEのGUIも使いたい場合はVNC(<a href="https://www.realvnc.com/" target="_blank">RealVNC</a>など)、<a href="https://help.ubuntu.com/community/FreeNX" target="_blank">FreeNX</a>、<a href="http://www.straightrunning.com/xmingnotes/" target="_blank">Xming</a>などで画面転送する方法があります（Xmingは動作が遅いので使わない方がいい）。
...
本コースでは、開発環境のOSは特に指定はありませんが、いろいろなOSで試したい場合は、マルチブートとVMWare Playerによる仮想化の方法があります。<br>
